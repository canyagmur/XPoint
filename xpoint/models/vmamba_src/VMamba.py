...
class VSSM(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.encoder_channels = dims # added by me to work with buildformer
    ...
    def forward(self, x: torch.Tensor): #here forward
...
if __name__ == "__main__":
        ...
        ssm_forwardtype = config.MODEL.VSSM.SSM_FORWARDTYPE
        ...
        #create sample input tensor 224x224
        ...
        class ShapePrinter:
            ...
            def __call__(self, module, input, output):
                self.idx += 1
                print(f"Layer {self.idx}: {module.__class__.__name__} - Input shape: {list(input[0].size())}, Output shape: {list(output.size())}")
        shape_printer = ShapePrinter()
        for name, module in model.named_modules():
            module.register_forward_hook(shape_printer)
